...
const About = () => {
  return (
    <>
      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 select-none">
        <p className="font-normal text-sm leading-3 text-primary dark:text-primary pb-2">
          About
        </p>
