...
import { currencies, navigation } from "@utils/Mocks/mockData";
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-6">
                          {category.featured.map((item) => (
                            <div key={item.name} className="group relative">
                              ...
                              <Link href={item.href}>
                                <a className="mt-2 block text-base font-medium text-gray-900">
                                  <span
                ...
                <div className="h-16 flex items-center justify-between">
                                  ...
                                  <Popover.Panel className="absolute top-full inset-x-0 text-sm text-gray-500">
                                    ...
                                    <div className="relative bg-white">
                                      <div className="max-w-7xl mx-auto px-8">
                                        <div className="grid grid-cols-4 gap-y-10 gap-x-8 py-12">
                                          {category.featured.map((item) => (
                                            <div
                                              key={item.name}
                  ...
                  <div className="flex-1 flex items-center justify-end">
                    <div className="flex items-center lg:ml-8">
                      ...
                      <div className="flow-root">
                        <Link href="/checkout">
                          <a className="group -m-2 p-2 flex items-center cursor-pointer">
                            <HiOutlineShoppingBag
